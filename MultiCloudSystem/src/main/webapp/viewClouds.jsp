...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td><%= rs.getString("ftp_host") %></td>
            <td><%= rs.getString("ftp_username") %></td>
        ...
        %>
        <tr>
            <td colspan="5">No Cloud Records Found</td>
        </tr>
        <%
                }

            } catch (Exception e) {
                out.println("<tr><td colspan='5'>Error loading cloud data</td></tr>");
                e.printStackTrace();
            }
        %>
    </table>
